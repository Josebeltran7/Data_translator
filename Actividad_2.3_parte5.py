...
#Agregar un control de tipo desplegable que muestre solamente las marcas:
#Ford
#Chevrolet
#Toyota
#Crear un gráfico de violín que, en su interior, muestre un gráfico de caja (ver imagen)
#El control desplegable debe filtrar el gráfico de violín
...
app.layout = html.Div(children=[
    html.H1(children='Grafico', style={'color':'black'}),
